-- Update the quest progress function to handle user_progress table
...
-- Create trigger on user_progress table to track lesson completions
DROP TRIGGER IF EXISTS track_lesson_completion_for_quests ON user_progress;
CREATE TRIGGER track_lesson_completion_for_quests
