...
import { BarChart3, BookOpen, Target, Award, TrendingUp, MessageSquare, Settings, Plus, Sparkles, User, Calendar, Clock, FileText } from 'lucide-react';
        ...
        <Tabs defaultValue="monitoring" className="w-full">
          ...
          <div className="space-y-8">
            ...
            <TabsContent value="tests" className="space-y-8">
              {user ? <TestManagement /> : <DemoAnalytics />}
            </TabsContent>
